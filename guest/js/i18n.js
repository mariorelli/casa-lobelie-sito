...
window.GUEST_I18N = {
  it: {
    ...
    nav: {
      ...
      checkin: "Check-in",
      checkout: "Check-out",
      transport: "Come muoversi",
      relax: "Area Relax",
      house: "La casa",
      parking: "Parcheggio",
      eat: "Mangiare vicino",
      shopping: "Shopping e servizi",
      rome: "Scopri Roma",
      stay: "Per il tuo soggiorno",
      rules: "Regole",
      emergency: "Emergenze",
      contact: "Contatta l'host"
    },
    navDesc: {
      wifi: "Connettetevi in un attimo",
      checkin: "Orari e documenti",
      checkout: "Come lasciare la casa",
      transport: "Bus, metro e dintorni",
      relax: "La vasca idromassaggio",
      house: "Climatizzazione, cucina e comfort",
    ...
    quickAccessArrival: "Come arrivare",
    wifi: {
      title: "Wi-Fi",
      subtitle: "Connettetevi in un attimo.",
      network: "Rete Wi-Fi",
      password: "Password",
      copy: "Copia password",
      copied: "Copiata!",
    ...
    checkout: {
      title: "Check-out",
      hoursLabel: "Orario di check-out",
      steps: [
        "Controllate di non aver dimenticato oggetti personali",
        "Lasciate l'appartamento in condizioni decorose",
        "Comunicate eventuali problemi riscontrati",
        "Seguite le istruzioni di Mario per la consegna delle chiavi"
      ]
    },
    relax: {
      title: "La tua pausa di relax",
      hoursLabel: "Orario vasca",
      beforeEntering: "Prima di entrare",
      duringUse: "Durante l'utilizzo",
      afterUse: "Dopo l'utilizzo",
      importantRules: "Regole importanti",
      warningLabel: "Avviso importante",
      problemsTitle: "Problemi o dubbi?",
    ...
    rules: {
      ...
      subtitle: "Poche regole semplici, per una convivenza serena con i vicini e gli altri ospiti."
    },
    eat: {
    ...
    emergency: {
      title: "Emergenze",
      numberLabel: "Numero unico di emergenza",
      call: "Chiama",
      otherTitle: "Altri contatti utili",
      otherEmpty: "Nessun altro contatto configurato al momento."
    },
    contact: {
    ...
    whatsappFloating: "Hai bisogno di aiuto? Scrivici su WhatsApp",
    whatsappDefaultMessage: "Ciao, sono un ospite di Casa Lobelie e avrei bisogno di un'informazione.",
    qr: {
      title: "QR Code della guida",
      subtitle: "Da stampare ed esporre in appartamento.",
  ...
  en: {
    ...
    tagline: "ROME",
    appTitle: "Casa Lobelie",
    welcomeTitle: "Welcome to Casa Lobelie",
    welcomeSubtitle: "Everything you need to enjoy your stay in Rome, simply and comfortably.",
    quickAccess: "Quick access",
    allSections: "Explore the guide",
    duringStayTitle: "During your stay",
    needSomethingTitle: "Need something?",
    back: "Back",
    home: "Home",
    nav: {
      wifi: "Wi-Fi",
    ...
    navDesc: {
      wifi: "Get connected in a moment",
      checkin: "Times and documents",
      checkout: "How to leave the house",
      transport: "Bus, metro and around",
      relax: "The hot tub",
      house: "Air conditioning, kitchen and comfort",
      parking: "Where to leave the car",
      eat: "Mario's recommendations",
      shopping: "Supermarkets and useful services",
      rome: "The most beautiful sights",
      stay: "A little extra for you",
      rules: "A few simple rules",
      emergency: "Single number 112",
      contact: "Message Mario"
    },
    quickAccessArrival: "Getting here",
    wifi: {
      title: "Wi-Fi",
      subtitle: "Get connected in a moment.",
    ...
    checkin: {
      title: "Check-in",
      hoursLabel: "Check-in time",
      text: "Arrival is arranged directly with Mario before your stay, so we can agree on the most convenient time together. As required by Italian public safety regulations, a valid ID document is needed for each guest at arrival."
    },
    checkout: {
      title: "Check-out",
      hoursLabel: "Check-out time",
      steps: [
        "Check you haven't forgotten any personal belongings",
        "Leave the apartment in a tidy condition",
        "Let us know about any issues you noticed",
        "Follow Mario's instructions for returning the keys"
      ]
    },
    relax: {
      title: "Your relax time",
      hoursLabel: "Hot tub hours",
      beforeEntering: "Before entering",
      duringUse: "While using the hot tub",
      afterUse: "After use",
      importantRules: "Important rules",
      warningLabel: "Important notice",
      problemsTitle: "Questions or issues?",
    ...
    parking: {
      ...
      noPrivate: "A private or reserved parking spot is not available."
    },
    house: {
      title: "The house",
      sections: {
    ...
    rules: {
      title: "House rules",
      subtitle: "A few simple rules, for a pleasant stay alongside our neighbours and other guests."
    },
    eat: {
      title: "Eat nearby",
    ...
    shopping: {
      ...
      subtitle: "Supermarkets, pharmacies, tobacconists and other useful services will be added here soon.",
      empty: "This section is ready to host useful places nearby.",
      directions: "Directions",
      call: "Call"
    },
    rome: {
      title: "Discover Rome",
      subtitle: "The most beautiful sights, seen from Casa Lobelie.",
      openRoute: "Open route"
    },
    stay: {
      title: "For your stay",
      subtitle: "A few extra touches to make your stay even more special.",
      request: "Request on WhatsApp",
      priceOnRequest: "Price on request"
    },
    emergency: {
      title: "Emergency",
      numberLabel: "Single emergency number",
      call: "Call",
      otherTitle: "Other useful contacts",
      otherEmpty: "No other contacts configured at the moment."
    },
    contact: {
      title: "Contact the host",
      subtitle: "Mario welcomes you to Casa Lobelie: message him on WhatsApp for anything you need.",
      whatsappButton: "Message on WhatsApp",
      hostSince: "Your host since 2023"
    },
    whatsappFloating: "Need help? Message us on WhatsApp",
    whatsappDefaultMessage: "Hi, I'm a guest at Casa Lobelie and I'd need some information.",
    qr: {
      title: "Guide QR code",
      subtitle: "Print it and display it in the apartment.",
      download: "Download PNG",
      print: "Print"
    },
    installApp: "Add this guide to your phone's Home screen to open it faster."
  },
  ...
  es: {
    ...
    relax: {
      title: "Vuestro momento de relax",
    ...
    parking: {
      title: "Aparcamiento",
      free: "Aparcamiento gratuito en la calle",
      noPrivate: "No hay disponible una plaza de aparcamiento privada o reservada."
    },
    house: {
      title: "La casa",
      sections: {
...
window.GUEST_LANGS = ["it", "en", "es", "fr"];
